...
const addProgram = async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({ message: "Program added", programs: updatedContent.programs });
  } catch (error) {
...
const deleteProgram = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Program deleted", programs: updatedContent.programs });
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
...
const deletePartner = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Partner deleted", partners: updatedContent.partners });
  } catch (error) {
    res.status(500).json({ error: error.message });
  }
};
